...
export default function ComingSoon({ title, description }: ComingSoonProps) {
  return (
    <section className="mx-auto flex min-h-[60vh] max-w-2xl flex-col items-center justify-center px-6 py-24 text-center">
      ...
      <h1 className="mt-6 text-3xl font-bold text-ink dark:text-neutral-50 md:text-5xl">{title}</h1>
      <p className="mt-4 max-w-lg leading-relaxed text-neutral-500 dark:text-neutral-400">
        {description}
      </p>
      <Link
        href="/"
